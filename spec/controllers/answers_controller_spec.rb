...
RSpec.describe AnswersController, type: :controller do
  ...
  describe 'PATCH #update' do
    ...
    context 'valid attributes' do
      before do
        patch :update, question_id: question,
                       id: answer,
                       answer: { text: 'new body' },
                       format: :js
      end
    ...
    context 'invalid attributes' do
      ...
      it 'does not change question attributes' do
        answer.reload
        expect(answer.text).not_to eq nil
      end
    ...
    context 'another authenticated user' do
      ...
      it 'does not changes answer attributes' do
        answer.reload
        expect(answer.text).not_to eq 'new body'
      end
  ...
  describe 'PATCH #best_answer' do
    ...
    context 'author question cancel best answer' do
      ...
      before do
        patch :cancel_best, question_id: question, id: answer_best, format: :js
      end
